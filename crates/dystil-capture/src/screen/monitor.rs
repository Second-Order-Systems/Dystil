...
/// Coupling these means dystil captures exactly the pixels it stores —
...
mod tests {
    ...
    /// (user's dystil at 13.2 GB RSS after ~48 h).
    ///
    ...
    /// test — run with:
    ///   cargo test -p dystil-screen --lib monitor::tests::repro_list_monitors_autorelease_leak -- --ignored --nocapture
    #[cfg(target_os = "macos")]
