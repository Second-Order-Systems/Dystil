...
use crate::a11y::tree::macos_lines::{self, NormalizeRefs};
...
/// (`dystil_capture::paired_capture::walk_accessibility_tree` calls
...
pub struct MacosTreeWalker {
    ...
    incognito_detector: Box<dyn crate::a11y::incognito::IncognitoDetector>,
}
...
impl MacosTreeWalker {
    pub fn new(config: TreeWalkerConfig) -> Self {
        Self {
            config,
            incognito_detector: crate::a11y::incognito::create_detector(),
        }
    }
}
