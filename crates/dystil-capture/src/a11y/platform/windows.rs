...
use crate::a11y::activity_feed::{ActivityFeed, ActivityKind};
use crate::a11y::config::{ExtractionThreadPriority, UiCaptureConfig};
use crate::a11y::events::{ElementContext, EventData, UiEvent, WindowTreeSnapshot};
use crate::pii_removal::remove_pii;
use anyhow::Result;
use chrono::Utc;
...
/// They must be skipped rather than attributed to the app, otherwise activity captured
...
mod tests {
    ...
    fn make_test_state(tx: crossbeam_channel::Sender<UiEvent>, text: &str) -> HookState {
        HookState {
            ...
            config: crate::a11y::config::UiCaptureConfig::default(),
            last_mouse_pos: (0, 0),
