!macro NSIS_HOOK_PREINSTALL
  ; Kill dystil processes before installation.
  nsExec::ExecToLog 'taskkill /F /T /IM dystil.exe'
  nsExec::ExecToLog 'taskkill /F /T /IM dystil-app.exe'
...
!macro NSIS_HOOK_POSTUNINSTALL
  ...
  RMDir /r "$LOCALAPPDATA\dystil\git-portable"
  ; Remove parent dir only if empty (preserves other dystil data)
  RMDir "$LOCALAPPDATA\dystil"
!macroend
